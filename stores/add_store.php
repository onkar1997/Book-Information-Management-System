<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if($iquery) {
            ...
            echo "<script>alert('Oops ! Something went wrong. Please Check the details ! ! !')</script>";
        }
    }
?>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container form-container mt-5">
            ...
            <h2 class="text-center pb-3">Add Store</h2>
            <hr>
            <form class="row g-3 needs-validation" action="/book-ims-php/index.php" method="POST">
                <div class="col-12">
